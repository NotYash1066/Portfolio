...
export default function AIPage() {
    return (
        <div className="section-container">
            ...
            <MotionSection delay={0.15} id="examples" data-rail="Examples">
                <h2><TypewriterText text="Implementation Examples" /></h2>
            </MotionSection>

            <MotionSection delay={0.2} id="safe-plate" data-rail="Safe-Plate">
                <div className="panel">
            ...
            <MotionSection delay={0.25} id="collegeinfo" data-rail="CollegeInfo">
                <div className="panel">
